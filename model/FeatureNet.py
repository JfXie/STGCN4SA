...
def build_FeatureNet(opt, channels=20, time_second=60, freq=200):
    ...
    fea_sigmoid = Activation(activation='sigmoid')(merged)

    # FeatureNet with sigmoid
    fea_model = Model(input, fea_sigmoid)
    fea_model.compile(optimizer=opt,
